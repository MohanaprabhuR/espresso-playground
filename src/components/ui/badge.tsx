...
const badgeVariants = cva(
  "inline-flex items-center outline-none justify-center rounded-5xl transition-all ease-in-out leading-loose tracking-4  text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        sm: "px-1.5 py-px text-xs font-normal [&>svg]:size-2.5",
        md: "px-1.5 py-[3px] text-xs font-normal [&>svg]:size-3",
        lg: "px-2 py-[4.5px] text-sm font-normal [&>svg]:size-3",
      },
    },
    defaultVariants: {
      variant: "default",
