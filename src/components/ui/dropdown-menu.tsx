...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "text-muted-foreground px-2 py-1.5 text-sm font-medium data-[inset]:pl-8 leading-tight tracking-4",
        className
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <kbd
      ...
      className={cn(
        "bg-background text-muted-foreground/70 leading-tight tracking-4 ms-auto -me-1 inline-flex  max-h-full items-center shadow-md rounded-sm p-1 font-[inherit] text-xs font-normal",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-accent  focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex cursor-default items-center rounded-lg px-2 py-1.5 text-base font-normal gap-2 leading-tight  tracking-4 outline-hidden  select-none data-[inset]:pl-8",
        className
      )}
      {...props}
    >
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "bg-popover text-popover-foreground shadow-md leading-tight   cursor-default items-center rounded-lg px-2 py-1.5 text-base font-normal gap-2 tracking-4 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-40 overflow-hidden p-1  ",
        className
      )}
      {...props}
    />
