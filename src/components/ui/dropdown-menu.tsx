...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-accent leading-loose  focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex cursor-default items-center rounded-lg px-2 py-1.5 text-base font-normal gap-2  tracking-4 outline-hidden  select-none data-[inset]:pl-8",
        className
      )}
      {...props}
    >
