...
function SidebarHeader({
  ...
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "flex gap-2 items-center px-1 pb-2 pt-1 text-foreground truncate font-medium text-base tracking-4 leading-tight",
        className
      )}
      {...props}
    >
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col p-2 pt-1.5  pb-3.5 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col pb-3.5", className)}
      {...props}
    />
  );
}
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform  focus-visible:ring-2 focus-visible:bg-sidebar-primary focus-visible:text-sidebar-primary-foreground focus-visible:ring-sidebar-ring [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform   focus-visible:ring-2 focus-visible:bg-sidebar-primary focus-visible:text-sidebar-primary-foreground  focus-visible:ring-sidebar-ring [&>svg]:size-4 [&>svg]:shrink-0",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 md:after:hidden",
