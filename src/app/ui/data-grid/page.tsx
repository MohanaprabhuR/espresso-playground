            ...
            options: [
              {
                label: "Beginner",
                value: "beginner",
                images: "https://mockmind-api.uifaces.co/content/human/80.jpg",
              },
              {
                label: "Intermediate",
                value: "intermediate",
                images: "https://mockmind-api.uifaces.co/content/human/81.jpg",
              },
              {
                label: "Advanced",
                value: "advanced",
                images: "https://mockmind-api.uifaces.co/content/human/82.jpg",
              },
              {
                label: "Expert",
                value: "expert",
                images: "https://mockmind-api.uifaces.co/content/human/83.jpg",
              },
            ],
          },
        },
        ...
        meta: {
          cell: {
            ...
            options: [
              ...
              {
                images: "https://mockmind-api.uifaces.co/content/human/84.jpg",
                label: "Manual",
                value: "manual",
              },
              {
                images: "https://mockmind-api.uifaces.co/content/human/85.jpg",
                label: "Slide",
                value: "slide",
              },
            ],
